...
function para = paraopt32_2()

% Lambda_h=10^3/(55*365);    % 10^3/(55*365) per day human birth rate
Lambda_h=(9*10^3*180)/(55*365);            % 10^3/(55) per year
...
delta_h=.000073*180;         %[0 41/10^5(0.00014)]*365 per year
...
p_h=0.03;    % 22/10^3; [.01 .27] disease transmission probability from infectious human
...
beta_0=175.6;   % average rate of mosquito biting rate per day, 0.30 for SO of nonauto model
...
repos=0.32;     %reporting probability
